  ...
  <div class="container text-center pt-4">
    ...
    <table class="table table-striped">
      ...
      <tr v-for="user in users" :key="user.id">
        ...
        <td>
          <i class="fa-solid fa-pen-to-square text-primary me-2" data-toggle="modal" data-target="#addUserModal"
             @click="updateUserModal(user)"></i>
          <i class="fa-solid fa-trash text-danger" data-bs-toggle="modal" data-bs-target="#exampleModal"
             @click="passDate(user.id)"></i>
        </td>
      </tr>
      </tbody>
      <div v-else>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group">
                <input v-model="password" name="password" :type="addUserForm ? 'password' : 'hidden'"
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="addUserForm ? saveUser() : updateUser()"
                    :disabled="isSaving">
    ...
    async saveUser() {
      ...
      try {
        ...
        if (errors) {
          ...
          const message = e.response.data?.message || 'Something went wrong on the server.';
          this.showToast(message, 'error');
        } else if (e.request) {
          this.showToast('No response from server. Please try again later.', 'error');
        } else {
